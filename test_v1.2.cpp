...
public:
    ...
    void testCopyConstructor() {
        ...
        testResult(kopija.getVardas() == "Petras", "Kopijavimo konstruktorius: vardas");
        testResult(kopija.getPavarde() == "Petraitis", "Kopijavimo konstruktorius: pavarde");
        testResult(kopija.getTarpRez().size() == 2, "Kopijavimo konstruktorius: tarp_rez dydis");
        testResult(kopija.getTarpRez()[0] == 8, "Kopijavimo konstruktorius: pirmas rez");
        testResult(kopija.getTarpRez()[1] == 9, "Kopijavimo konstruktorius: antras rez");
        testResult(kopija.getEgzRez() == 10, "Kopijavimo konstruktorius: egz_rez");
        testResult(floatEquals(kopija.getGalutinis(), 9.5f), "Kopijavimo konstruktorius: galutinis");
        
        kopija.setVardas("Antanas");
        testResult(original.getVardas() == "Petras", "Kopijavimo konstruktorius: nepriklausomumas");
    }
    ...
    void testMoveConstructor() {
        ...
        testResult(perkeltas.getVardas() == originalVardas, "Move konstruktorius: vardas perkeltas");
        testResult(perkeltas.getPavarde() == "Onutė", "Move konstruktorius: pavarde perkelta");
        testResult(perkeltas.getTarpRez().size() == 2, "Move konstruktorius: tarp_rez perkeltas");
        testResult(perkeltas.getEgzRez() == 9, "Move konstruktorius: egz_rez perkeltas");
        testResult(floatEquals(perkeltas.getGalutinis(), 8.2f), "Move konstruktorius: galutinis perkeltas");
    }
    ...
    void testFullIntegration() {
        ...
        testResult(floatEquals(s4.getGalutinis(), 9.2f), "Integracijos testas: galutinis apskaiciuotas");
    }
    ...
    void runAllTests() {
        std::cout << "\n";
        std::cout << "╔══════════════════════════════════════════════════════════╗\n";
        std::cout << "║     V1.2 STUDENTAS KLASĖS TESTAI (Rule of Five + I/O)    ║\n";
        std::cout << "╚══════════════════════════════════════════════════════════╝\n";
        ...
        std::cout << "║  Sėkmės rodiklis:  " << std::fixed << std::setprecision(1) << std::setw(30) << percentage << "% ║\n";
        std::cout << "╚══════════════════════════════════════════════════════════╝\n";
